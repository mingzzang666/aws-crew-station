const bannerLayout = (() => {
        function list(urls) {
            ...
            urls.forEach((url) => {
                text += `
                <li class="registered-item" style="display:grid;grid-template-columns:120px 1fr auto;gap:12px;align-items:center;padding:10px 0;border-bottom:1px solid #f1f1f1;">
